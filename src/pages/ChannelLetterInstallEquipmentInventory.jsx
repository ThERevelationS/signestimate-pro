...
import { Plus, Trash2, Save, ArrowLeft, HardHat } from "lucide-react";
...
export default function ChannelLetterInstallEquipmentInventoryPage() {
        ...
        <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
              ...
              Install Equipment Inventory
            </h1>
            <p className="text-slate-600">Lifts, ladders, scaffolds & tools for channel letter installs</p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Link to={createPageUrl("ChannelLetterInstallInventory")}>
              <Button variant="outline" className="bg-white">Materials Inventory</Button>
            </Link>

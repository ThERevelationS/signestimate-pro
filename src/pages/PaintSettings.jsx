              ...
              <div className="border-t pt-6">
                ...
                <div className="mt-4 p-4 bg-amber-50 rounded-lg border border-amber-200">
                  ...
                  <div className="space-y-1 text-xs text-amber-700">
                    ...
                    <p className="font-semibold text-amber-900">• Total mixing time: {mixingExample.numberOfMixes} mixes × {mixingExample.mixingHoursPerGallon} hrs/gal = {mixingExample.totalMixingHours.toFixed(2)} hours</p>
                    <p className="mt-2 text-amber-800 italic border-t border-amber-300 pt-2">Note: Each gallon (or partial) requires a separate mix. Mixing time scales with volume, not item quantity.</p>
                  </div>
                </div>
              </div>
            </>

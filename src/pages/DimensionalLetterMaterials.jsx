...
import { ArrowLeft, Plus, Trash2, Copy, Save, Box, Layers, Search } from "lucide-react";
import { createPageUrl } from "@/utils";
import { useToast } from "@/components/ui/use-toast";
import { materialCostPerSqin } from "@/components/channelLetterInstall/dimensionalFabCalculator";
...
export default function DimensionalLetterMaterials() {
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-500">Sheet material library used for dimensional letter fabrication.</p>
          </div>

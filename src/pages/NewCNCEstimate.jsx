...
├─ Dimensions:      ${item.length}" × ${item.width}" × ${item.material_thickness}"
├─ Job Type:        ${item.item_type}
├─ Quantity:        ${item.quantity}
│
├─ Machine Time:    ${item.machine_time_hours.toFixed(2)} hrs
├─ Labor Time:      ${item.setup_time_hours.toFixed(2)} hrs
│
...
COST SUMMARY
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Total Machine Cost:         $${totalMachine.toFixed(2)}
...
`;
    ...
    a.href = url;
    a.download = `${project.project_name.replace(/\s+/g, '_')}_CNC_Estimate.txt`;

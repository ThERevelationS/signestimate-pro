...
│
├─ Type:            ${item.item_type}
├─ Dimensions:      ${item.length}"L × ${item.width}"H × ${item.thickness}" thick
├─ Quantity:        ${item.quantity}
...
│
├─ Paint Mask:      $${(item.supplies_cost || 0).toFixed(2)}
├─ Paint Cost:      $${(item.paint_cost || 0).toFixed(2)}
├─ Labor Hours:     ${(item.labor_hours || 0).toFixed(1)} hrs
...
`;
    ...
    a.href = url;
    a.download = `${project.project_name.replace(/\s+/g, '_')}_Paint_Estimate.txt`;

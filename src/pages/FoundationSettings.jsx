    ...
    <div>
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Concrete Settings</h1>
            <p className="text-slate-500 text-sm">Configure pricing and labor rates for concrete & pole estimates</p>
          </div>

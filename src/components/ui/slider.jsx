...
const Slider = React.forwardRef(({ className, colorClass, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Track
      ...
      <SliderPrimitive.Range className={cn("absolute h-full transition-colors", colorClass || "bg-primary")} />
    </SliderPrimitive.Track>

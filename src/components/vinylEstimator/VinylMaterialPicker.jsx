// Picks the base vinyl + optional laminate. Auto-fills laminate from the
// chosen vinyl's `default_laminate_id` when applicable.
...
export default function VinylMaterialPicker({ vinyls, vinylId, laminateId, applyLaminate, onChange }) {
